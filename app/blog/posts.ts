...
export const POSTS: Post[] = [
  {
    ...
    blocks: [
      ...
      { kind: 'p', text: 'SIMD-0437 lowers lamports_per_byte from 6,960 to 696 across five independently gated stages — a 90% reduction once all five activate. The formula is untouched; only the rate moves.' },
      { kind: 'table', head: ['Gate', 'Lamports/byte', 'Floor for 165B', 'Recoverable'], rows: [
        ['Legacy', '6,960', '0.00203928', '—'],
        ['SIMD-0437-1', '6,333', '0.00185557', '0.00018371'],
        ['SIMD-0437-2', '5,080', '0.00148844', '0.00055084'],
        ['SIMD-0437-3', '2,575', '0.00075448', '0.00128481'],
        ['SIMD-0437-4', '1,322', '0.00038735', '0.00165193'],
        ['SIMD-0437-5', '696', '0.00020393', '0.00183535'],
      ] },
  ...
  },
  {
    ...
    blocks: [
      ...
      { kind: 'p', text: 'SIMD-0437 lowers the rent rate in five gated stages rather than all at once. Each activation drops the floor again and leaves a fresh surplus in every account funded before it. Closing an account is a one-time event; withdrawing the excess is something you can do again after every gate.' },
  ...
  },
  {
    ...
    blocks: [
      ...
      { kind: 'p', text: 'Memory got cheaper; the rate did not follow. SIMD-0437 corrects that by stepping lamports_per_byte down from 6,960 to 696 in five gated stages — a 90% reduction at full rollout. Opening new accounts gets dramatically cheaper, which is the point of the proposal.' },
