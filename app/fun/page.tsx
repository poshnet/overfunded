  ...
  return (
    <main className="fun-shell">
      ...
      <nav className="fun-nav">
        <a className="fun-brand" href="/fun"><i>O</i><b>OVERFUNDED</b><em>FUN LAB</em></a>
      ...
      <section className="fun-final">
        <div className="fun-final-marks" aria-hidden="true"><i>O</i><i>◎</i><i>↓</i></div>
      ...
      <footer className="fun-footer"><a className="fun-brand" href="/fun"><i>O</i><b>OVERFUNDED</b><em>FUN LAB</em></a><p>Built for Solana’s reduced-rent era.</p><div><a href="/">Live app</a><a href="/solana-rent-reduction">How the cut works</a><a href="#why">Safety</a></div></footer>
    </main>
  );
}
