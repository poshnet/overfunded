    ...
    <main className="fun-shell">
      ...
      <section className="fun-hero">
        <div className="fun-hero-copy">
          ...
          <p>Old token accounts may be holding more rent than they need. Lamport finds the extra and sends it home—without deleting a thing.</p>
      ...
      <section className="fun-proof" id="why">
        <div className="fun-section-heading">
          ...
          <span>Lamport is not an account burner. It uses the Token Program’s excess-lamport withdrawal path to move only what sits above today’s rent floor.</span>
        </div>
      ...
      <section className="fun-versus" aria-label="Account closing compared with Lamport reclaim">
        <div className="fun-versus-title"><span>DELETE BUTTON ENERGY</span><h2>Burner <b>vs.</b> Lamport</h2></div>
        ...
        <div className="fun-versus-card good">
          <div className="fun-card-tag">LAMPORT RECLAIM</div>
